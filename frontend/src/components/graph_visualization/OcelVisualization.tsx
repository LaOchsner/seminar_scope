...
//     // 2. Subscribe to the actual colorMap.
//     // This is crucial: it forces this component to re-render whenever the color map changes.
...
//             tooltip.remove();
//         };
//     // 3. CRITICAL: Added 'colorMap' to dependencies.
